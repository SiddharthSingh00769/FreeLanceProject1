...
function Services() {
  return (
    <div className='h-auto xl:h-[100vh] w-full bg-blue-950 sm:overflow-hidden flex flex-col-reverse xl:flex-row'>
      <div className='w-[100%] xl:w-[74%] p-4 grid grid-cols-1 lg:grid-cols-4 gap-4'>
        <div className='min-h-[18rem] min-w-[12rem] bg-teal-500 rounded-xl lg:row-span-2 flex flex-col justify-center items-center p-4'>
        ...
        <div className='min-h-[18rem] min-w-[12rem] bg-teal-500 rounded-xl lg:col-span-3 flex flex-col justify-center items-center p-4'>
            <div><ImHeadphones className='h-[4rem] w-[4rem]'/></div>
            <div className='text-2xl font-bold'>TELEMARKETING</div>
            <div className='text-base text-center px-4'>Unlock the full potential of your growing business by leveraging compellingselling propositions and a strategic lead generation approach. By clearly articulating the unique benefits of yourproducts or services, you can effectively capture the attention of your target audience. Our tailored strategies focus onidentifying and nurturing leads, ensuring that you not only attract potential customers but also convert them into loyalclients. With a well-defined plan in place, you can enhance your market presence and drive sustainable growth, positioningyour business for long-term success.</div>
        </div>
        <div className='min-h-[18rem] min-w-[12rem] bg-teal-500 rounded-xl flex flex-col justify-center items-center'>
        ...
        <div className='min-h-[18rem] min-w-[12rem] bg-teal-500 rounded-xl flex flex-col justify-center items-center'>
            ...
            <div className='text-2xl font-bold text-center'>MEDICAL REVENUE MANAGEMENT</div>
            <div className='text-base text-center px-4'>We enhance your organization with telemarketing, IT solutions, digital marketing, and revenue management for healthcare providers, ensuring efficiency and profitability.</div>
        </div>
      </div>
